 ...
 * DevicePolicyManager#ACTION_PROVISIONING_SUCCESSFUL} activity intent or the {@link
 * android.app.admin.DeviceAdminReceiver#onProfileProvisioningComplete(Context, Intent)} broadcast.
 *
 * <p>Operations performed:
 *
 * <ul>
 *   <li>self-grant all run-time permissions
 *   <li>enable the launcher activity
 *   <li>start waiting for first account ready broadcast
 * </ul>
 */
